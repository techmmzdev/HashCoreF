      ...
      <div className="px-4 sm:px-6 pb-4 sm:pb-6">
        ...
        <div className="flex flex-col items-center -mt-10 sm:-mt-12">
          <div className="relative">
            <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white rounded-full flex items-center justify-center shadow-xl border-4 border-white transition-transform hover:scale-105">
              <User className="w-10 h-10 sm:w-12 sm:h-12 text-yellow-600" />
            </div>
            {/* Status indicator */}
            <div className="absolute bottom-1 right-1 sm:bottom-2 sm:right-2">
              <div
                className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 sm:border-3 border-white ${
          ...
          <h2 className="mt-3 sm:mt-4 text-lg sm:text-xl font-bold text-gray-900 text-center leading-tight px-2">
            {user?.name}
          </h2>
          <p className="text-xs sm:text-sm text-gray-600 mt-1 text-center break-all px-2">
            {user?.email}
          </p>

          {/* Status badge */}
          <div className="mt-3 sm:mt-4 flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-50">
            <div
        ...
        <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200">
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-yellow-100 flex items-center justify-center shrink-0">
                <Calendar className="w-4 h-4 sm:w-4.5 sm:h-4.5 text-yellow-600" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-xs text-gray-500 font-medium">
                  Miembro desde
                </p>
                <p className="text-sm sm:text-base text-gray-900 font-semibold mt-0.5 truncate">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-blue-100 flex items-center justify-center shrink-0">
                <Shield className="w-4 h-4 sm:w-4.5 sm:h-4.5 text-blue-600" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-xs text-gray-500 font-medium">
                  Rol de usuario
                </p>
                <p className="text-sm sm:text-base text-gray-900 font-semibold mt-0.5">
                  Cliente
                </p>
              </div>
            </div>
            ...
            <div className="sm:hidden flex items-start gap-3 p-3 rounded-lg bg-linear-to-br from-purple-50 to-pink-50 border border-purple-200">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-900 font-bold mt-0.5 flex items-center gap-2">
                  {clientData?.plan}
